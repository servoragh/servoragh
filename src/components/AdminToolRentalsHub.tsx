          ...
          filteredRentals.map((item) => (
            ...
            >
              <div className="space-y-2.5">
                <div className="w-full h-36 rounded-2xl overflow-hidden bg-stone-100 dark:bg-stone-950 border border-stone-200 dark:border-stone-800 relative flex items-center justify-center">
                  {item.images && item.images[0] ? (
                    ...
                    <Wrench className="w-8 h-8 text-stone-400 opacity-40" />
                  )}
                  <span
