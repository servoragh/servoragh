      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs rounded-xl shadow transition flex items-center justify-center gap-2 cursor-pointer"
          >
        ...
        {/* JIJI-STYLE 4-COLUMN CATEGORY ICON GRID */}
        ...
        <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 p-4 rounded-3xl mb-8 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 shadow-xs">
          <form onSubmit={handleSearchSubmit} className="flex-1 flex items-center gap-2 bg-stone-100 dark:bg-stone-800 px-3 py-2 rounded-2xl border border-stone-200 dark:border-stone-700">
            ...
            />
            <button type="submit" className="px-3 py-1 bg-emerald-600 text-white text-xs font-bold rounded-xl cursor-pointer">
              Search
            </button>
          </form>
